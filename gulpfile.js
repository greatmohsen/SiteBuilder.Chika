...
gulp.task('bootstrap.watch', function () {
	return gulp.watch(['./scss/bootstrap.custom.scss', './scss/bootstrap.rtl.scss', './scss/bootstrap.scss', './scss/bootstrap.variables.scss', './scss/bootstrap.base.scss'], ['bootstrap.sass']);
});
